...
export async function createTemplate(_payload) {
  throw new Error("Cadastro de templates (legado) não está habilitado neste schema.");
}

export async function deleteTemplate(_id) {
  throw new Error("Exclusão de templates (legado) não está habilitada neste schema.");
}

export async function createTemplateItem(_payload) {
  throw new Error("Cadastro de itens (legado) não está habilitado neste schema.");
}

export async function deleteTemplateItem(_id) {
  throw new Error("Exclusão de itens (legado) não está habilitada neste schema.");
}
