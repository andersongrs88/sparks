...
function computeDefaultsFromImmersion({ immersion, phase }) {
  ...
  // Regra do produto (2026-01): por padrão, todas as tarefas devem ser atribuídas ao Dono da imersão.
  // Se não houver dono definido (bases antigas), fazemos fallback para consultor e, por fim, null.
  const responsible_id = immersion?.checklist_owner_id || immersion?.educational_consultant || null;
